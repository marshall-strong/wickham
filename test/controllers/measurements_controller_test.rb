...
class MeasurementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create measurement" do
    assert_difference('Measurement.count') do
      post measurements_url, params: { measurement: { quantity: @measurement.quantity, unit: @measurement.unit } }
    end
  ...
  test "should update measurement" do
    patch measurement_url(@measurement), params: { measurement: { quantity: @measurement.quantity, unit: @measurement.unit } }
