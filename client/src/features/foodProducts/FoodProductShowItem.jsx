...
import { selectFoodProductById } from "./foodProductsSlice";

const FoodProductShowItem = ({ foodProductId }) => {
  const foodProduct = useSelector((state) =>
    selectFoodProductById(state, foodProductId)
  );
  return (
    <article className="FoodProduct p-4 flex space-x-4">
      <img
...
export default FoodProductShowItem;
